 ...
 */
public class RekeningAwalService implements BaseServiceInterface, Serializable {

    private static final long serialVersionUID = 8371351611167972213L;

    private final GrailsRestClient grc = new GrailsRestClient();
    private final Gson gson = new Gson();
    private final String endpoint = "rekeningAwal";

    @Override
    public Object listAll() {
        String response = grc.get(endpoint);
        Type type = new TypeToken<ArrayList<RekeningAwal>>() {
        }.getType();
    ...
    public Object save(Object obj) {
        RekeningAwal invoice = (RekeningAwal) obj;
    ...
    public Object get(long id) {
        ...
        return gson.fromJson(response, RekeningAwal.class);
    }
    ...
    public boolean checkRekening(long rekeningId, long perusahaanId) {
        String response = grc.get(endpoint + "/checkRekening?rekeningId=" + rekeningId + "&perusahaanId=" + perusahaanId);
